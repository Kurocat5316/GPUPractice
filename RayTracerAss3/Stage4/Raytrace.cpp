...
void renderGPU(Scene scene, const int width, const int height, const int aaLevel)
{
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferCameraPosition object\n");
		exit(1);
	}
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferMaterialContainer object\n");
		exit(1);
	}
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferSphereContainer object\n");
		exit(1);
	}
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferTriangleContainer object\n");
		exit(1);
	}
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferLightContainer object\n");
		exit(1);
	}
	...
	if (err != CL_SUCCESS) {
		printf("Couldn't create a clBufferOut object\n");
		exit(1);
	}
